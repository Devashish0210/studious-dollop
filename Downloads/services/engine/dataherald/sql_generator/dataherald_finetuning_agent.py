...
class DataheraldFinetuningAgent(SQLGenerator):
    ...
    def generate_response(
        ...
        # openai_fine_tuning = OpenAIFineTuning(self.system, storage, None)
        ...
        toolkit = SQLDatabaseToolkit(
            ...
            openai_fine_tuning=None,
            embedding=embedding,
        )
        print(user_prompt.text,metadata,'chsjnckjanskjnakjnsdkjnakjsnkjandkjn')
