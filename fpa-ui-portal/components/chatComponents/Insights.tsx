...
export default function Insights({ insights, hideHeader = false }: InsightsProps) {
  ...
  return (
    ...
    >
      ...
      <div className="prose prose-sm dark:prose-invert max-w-none text-[var(--color-text-light)]">
